...
begin
 ...
 showmessage('hata oluþtu - DSPUANTAJMAASStateChange');
...
try
  ...
  Showmessage('Hata oluþtu -QPUANTAJMAASAfterDelete');
 end;
end;
...
BEGIN
raise EDatabaseError.Create('Nöbet Saatlerinizde uyumsuzluk Bulunmaktadýr');
END;
...
try
        ...
        {FRMNOBET_PUANTAJ.CYIL.Text+' '+ FRMNOBET_PUANTAJ.CAY.Text}BASLIK+' AYI '+ servis {FRMNOBET_PUANTAJ.cxLookupComboBox1.Text}+' NÖBET PUANTAJ CETVELÝ';
        (frxReport1.FindObject('MEMO2') AS TfrxMemoView).Text:=
        {FRMNOBET_PUANTAJ.CYIL.Text+'   '+ FRMNOBET_PUANTAJ.CAY.Text}BASLIK+'    Ayýnda Toplam '+
         FRMPUANTAJMAAS.AYLIK_TOP_SAAT+' saat  mesai  vardýr.';
...
try
          ...
          begin
                        ...
                        //if (FRMNOBET_PUANTAJ.gunler[AViewInfo.Item.Index-1]='CUMARTESÝ') then
...
showmessage('Hata oluþtu. -cxGrid1DBTableView1CustomDrawCell')
...
begin
 //showmessage( FRMNOBET_PUANTAJ.CYIL.Text+' '+ FRMNOBET_PUANTAJ.CAY.Text+' AYI '+ FRMNOBET_PUANTAJ.cxLookupComboBox1.Text+' NÖBET PUANTAJ CETVELÝ');
 try
