...
TRY
 ...
 EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-CAYPropertiesChange');
 EXIT;
 END;
...
try
 ...
 EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-CheckBox3Click');
 EXIT;
 END;
end;
...
TRY
 ...
 EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-cretBilgi1Click');
 EXIT;
 END;
end;
...
begin
      ...
      TRY
       ...
       qnobetac;
      EXCEPT
       sHOWMESSAGE('HATA OLUÞTU-cxLookupComboBox1PropertiesChange');
       EXIT;
       END;
end;
...
begin
 ...
 begin
        ...
        EXCEPT
         sHOWMESSAGE('HATA OLUÞTU-CYILPropertiesChange');
         EXIT;
         END;
 end;
end;
...
EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-DSLPERSONELDataChange');
 EXIT;
 END;
end;
...
EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-FazlaMesaiKontrol1Click');
 EXIT;
 END;
end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-GirikProblemliPersoneller1Click');
EXIT;
END;
end;
...
//memo1.Lines.Add(QNOBETCI.sql.text);
        QNOBETCI.Open;
         ...
         (frxReport1.FindObject('BASLIK') AS TfrxMemoView).Memo.Text:= FORMATDATETIME('DD.MM.YYYY',TAR)+' TARÝHÝ NÖBETÇÝ LÝSTESÝ';


         MessageDlg('Telefon Bilgisi Yazdýrýlsýn mý ?',mtConfirmation,mbYesNo,
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-GnlkNbetiler1Click');
EXIT;
END;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-GUNBUL');
EXIT;
END;
end;
        ...
        isaretvarmi(bir,tarih,nob,maas);
            ...
            //  cxGrid1DBTableView1.OptionsData.Editing:=TRUE;  guncelle
              ...
              begin
                  ...
                  BtnNob_kontrol.Caption:='Korunmuþtur';
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-isaretuygula');
EXIT;
END;
...
TRY
    ...
    result:=1;
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-isaretvarmi');
result:=1;
EXIT;
END;
end;
...
//
//          cxGrid1DBTableView1UCRET.editing:=false;          burayý komple guncelle
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-kapat');
EXIT;
END;
end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-ListeYaz1Click');
EXIT;
END
end;
...
TRY
 ...
 tar:=StrToDate( ComboBox1.Text+'.'+QNOBET.Params[1].Value);
 (frxReport1.FindObject('BASLIK') AS TfrxMemoView).Memo.Text:= FORMATDATETIME('DD.MM.YYYY',TAR)+' TARÝHÝ ÇALIÞAN PERSONEL LÝSTESÝ';


      if ComboBox1.Text='' then  EXIT;
      if QNOBET.Active=FALSE then  EXIT;

      //a:=InputBox('nasýlsýn','iyiyim','');
...
//      MEMO1.Lines.Add(QGUNLUK_CALISAN_LISTESI.SQL.TEXT);
      QGUNLUK_CALISAN_LISTESI.Open;
       ...
       tar:=StrToDate( ComboBox1.Text+'.'+QNOBET.Params[1].Value);
       (frxReport2.FindObject('BASLIK') AS TfrxMemoView).Memo.Text:=FORMATDATETIME('DD.MM.YYYY',TAR)+' TARÝHÝ ÇALIÞAN PERSONEL LÝSTESÝ';
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-MesaidekiPersoneller1Click');
EXIT;
END;
end;
...
//mesai doldur
 UniScreenMask1.Enabled:=True;
      ...
      TRY
            ...
            begin
              Showmessage('Doldurulacak Mesai aralýðýný giriniz !');
              EXIT;
            end;
...
//             cxLookupComboBox2.CLEAR;
        ...
        EXCEPT
        sHOWMESSAGE('HATA OLUÞTU-MesaiDoldur1Click');
        EXIT;
        END;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-mNbetleri1Click');
EXIT;
END;
end;
...
//        end;
          ...
          FRMPUANTAJMAAS.BASLIK:= qnobet_gunleri.Fieldbyname('YIL').ASSTRING;{+' AYI '+ FRMNOBET_PUANTAJ.cxLookupComboBox1.Text+' NÖBET PUANTAJ CETVELÝ'};
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-NbetPuanAc1Click');
EXIT;
END;
end;
...
TRY
  ...
  MessageDlg ('Mevcut Kayýtlar Silinecek ?' ,mtConfirmation, mbYesNo,
             procedure (Sender: TComponent; Res: Integer)
             begin
               ...
               case RES of
                 mrYes:
                  begin
                             if MAAS='X' then
                             BEGIN
                             SHOWMESSAGE('Mutemet Kontrolüne alýnmýþtýr');
                               EXIT;
                             END;
                            {
                            if (FRMGIRIS.NOB_KONTROL='X') AND (NOB='X') then
                            BEGIN
                              SHOWMESSAGE('Kayýtlar Korumaya Alýnmýþtýr');
                              exit;
                            END;
                                  }
                            if QNOBET.RecordCount<1 then
                            begin
                              showmessage('Secili Kayýt Bulunamadý');
                              exit;
                            end;
                            ...
                            begin
                              showmessage('Fazla Mesaili Personel Bulunamadý');
                              exit;
                            end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-NbetPuanHazrlaA1Click');
EXIT;
END;
...
//
//          cxGrid1DBTableView1UCRET.editing:=true;             burayýý komple guncelle

EXCEPT
sHOWMESSAGE('HATA OLUÞTU-ac');
EXIT
end;
end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-qnobetac');
EXIT;
END;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-QNOBETAfterOpen');
EXIT
END;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-QNOBETAfterPost');
EXIT
end;
...
try
    ...
    //DATA.transaction.CommitRetaining;
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-qsqlAfterExecute');
EXIT
end;
end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-RiskliBirimalanlar1Click');
EXIT
end;
end;
...
try
   {    A:=DaysInMonth(STRTODATE(B)) ;
        I:=STRTODATE(B);
                ...
                1:
                  BEGIN
                      ...
                      G1.Caption:=GUNBUL(I-1+X);
                        if G1.Caption='CUMARTESÝ' then   G1.Font.Color:=clRed
                 ...
                 2:
                  BEGIN
                      ...
                      G2.Caption:=GUNBUL(I-1+X);
                        if G2.Caption='CUMARTESÝ' then   G2.Font.Color:=clRed
                 ...
                 3:
                  BEGIN
                      ...
                      G3.Caption:=GUNBUL(I-1+X);
                        if G3.Caption='CUMARTESÝ' then   G3.Font.Color:=clRed
                 ...
                 4:
                  BEGIN
                      ...
                      G4.Caption:=GUNBUL(I-1+X);
                        if G4.Caption='CUMARTESÝ' then   G4.Font.Color:=clRed
                 ...
                 5:
                  BEGIN
                      ...
                      G5.Caption:=GUNBUL(I-1+X);
                        if G5.Caption='CUMARTESÝ' then   G5.Font.Color:=clRed
                 ...
                 6:
                  BEGIN
                      ...
                      G6.Caption:=GUNBUL(I-1+X);
                        if G6.Caption='CUMARTESÝ' then   G6.Font.Color:=clRed
                 ...
                 7:
                  BEGIN
                      ...
                      G7.Caption:=GUNBUL(I-1+X);
                        if G7.Caption='CUMARTESÝ' then   G7.Font.Color:=clRed
                 ...
                 8:
                  BEGIN
                      ...
                      G8.Caption:=GUNBUL(I-1+X);
                        if G8.Caption='CUMARTESÝ' then   G8.Font.Color:=clRed
                 ...
                 9:
                  BEGIN
                      ...
                      G9.Caption:=GUNBUL(I-1+X);
                        if G9.Caption='CUMARTESÝ' then   G9.Font.Color:=clRed
                 ...
                 10:
                  BEGIN
                      ...
                      G10.Caption:=GUNBUL(I-1+X);
                        if G10.Caption='CUMARTESÝ' then   G10.Font.Color:=clRed
                 ...
                 11:
                  BEGIN
                      ...
                      G11.Caption:=GUNBUL(I-1+X);
                        if G11.Caption='CUMARTESÝ' then   G11.Font.Color:=clRed
                 ...
                 12:
                  BEGIN
                      ...
                      G12.Caption:=GUNBUL(I-1+X);
                        if G12.Caption='CUMARTESÝ' then   G12.Font.Color:=clRed
                 ...
                 13:
                  BEGIN
                      ...
                      G13.Caption:=GUNBUL(I-1+X);
                        if G13.Caption='CUMARTESÝ' then   G13.Font.Color:=clRed
                 ...
                 14:
                  BEGIN
                      ...
                      G14.Caption:=GUNBUL(I-1+X);
                        if G14.Caption='CUMARTESÝ' then   G14.Font.Color:=clRed
                 ...
                 15:
                  BEGIN
                      ...
                      G15.Caption:=GUNBUL(I-1+X);
                        if G15.Caption='CUMARTESÝ' then   G15.Font.Color:=clRed
                 ...
                 16:
                  BEGIN
                      ...
                      G16.Caption:=GUNBUL(I-1+X);
                        if G16.Caption='CUMARTESÝ' then   G16.Font.Color:=clRed
                 ...
                 17:
                  BEGIN
                      ...
                      G17.Caption:=GUNBUL(I-1+X);
                        if G17.Caption='CUMARTESÝ' then   G17.Font.Color:=clRed
                 ...
                 18:
                  BEGIN
                      ...
                      G18.Caption:=GUNBUL(I-1+X);
                        if G18.Caption='CUMARTESÝ' then   G18.Font.Color:=clRed
                 ...
                 19:
                  BEGIN
                      ...
                      G19.Caption:=GUNBUL(I-1+X);
                        if G19.Caption='CUMARTESÝ' then   G19.Font.Color:=clRed
                 ...
                 20:
                  BEGIN
                      ...
                      G20.Caption:=GUNBUL(I-1+X);
                        if G20.Caption='CUMARTESÝ' then   G20.Font.Color:=clRed
                 ...
                 21:
                  BEGIN
                      ...
                      G21.Caption:=GUNBUL(I-1+X);
                        if G21.Caption='CUMARTESÝ' then   G21.Font.Color:=clRed
                 ...
                 22:
                  BEGIN
                      ...
                      G22.Caption:=GUNBUL(I-1+X);
                        if G22.Caption='CUMARTESÝ' then   G22.Font.Color:=clRed
                 ...
                 23:
                  BEGIN
                      ...
                      G23.Caption:=GUNBUL(I-1+X);
                        if G23.Caption='CUMARTESÝ' then   G23.Font.Color:=clRed
                 ...
                 24:
                  BEGIN
                      ...
                      G24.Caption:=GUNBUL(I-1+X);
                        if G24.Caption='CUMARTESÝ' then   G24.Font.Color:=clRed
                 ...
                 25:
                  BEGIN
                      ...
                      G25.Caption:=GUNBUL(I-1+X);
                        if G25.Caption='CUMARTESÝ' then   G25.Font.Color:=clRed
                 ...
                 26:
                  BEGIN
                      ...
                      G26.Caption:=GUNBUL(I-1+X);
                        if G26.Caption='CUMARTESÝ' then   G26.Font.Color:=clRed
                 ...
                 27:
                  BEGIN
                      ...
                      G27.Caption:=GUNBUL(I-1+X);
                        if G27.Caption='CUMARTESÝ' then   G27.Font.Color:=clRed
                 ...
                 28:
                  BEGIN
                      ...
                      G28.Caption:=GUNBUL(I-1+X);
                        if G28.Caption='CUMARTESÝ' then   G28.Font.Color:=clRed
                 ...
                 29:
                  BEGIN
                      ...
                      G29.Caption:=GUNBUL(I-1+X);
                        if G29.Caption='CUMARTESÝ' then   G29.Font.Color:=clRed
                 ...
                 30:
                  BEGIN
                      ...
                      G30.Caption:=GUNBUL(I-1+X);
                        if G30.Caption='CUMARTESÝ' then   G30.Font.Color:=clRed
                 ...
                 31:
                  BEGIN
                      ...
                      G31.Caption:=GUNBUL(I-1+X);
                        if G31.Caption='CUMARTESÝ' then   G31.Font.Color:=clRed
          ...
          END;  }
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-TARIHOLUSTUR');
EXIT
end;
end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-TSAATExit');
EXIT
end;
...
sHOWMESSAGE('HATA OLUÞTU-RzBitBtn1Click');
EXIT ;
end;
...
try
      ...
      QNOBET.Delete;
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-RzBitBtn2Click');
EXIT  ;
end;
end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-RzBitBtn4Click');
EXIT
end;
...
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-RzBitBtn5Click');
EXIT
end;
...
EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-AktifalListesiADSIRALI1Click');
 EXIT;
END;
...
TRY
 ...
 //    ShowMessage('aaa');
  ...
  //  frxRaktif_calisma.ShowReport(true);
    qaktif_cal_lis.Close;
EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-AktifalListesi1Click');
 EXIT;
END;
end;
...
TRY
 ...
 EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-AylkMesaiiMesaiDToplamSre1Click');
 EXIT;
END;
end;
...
TRY
        ...
        if (QNOBET.Active=FALSE) OR (QNOBET.RecordCount=0) then  EXIT;
          ...
          if qsor.Fields[0].Value>0 then
          begin
          ShowMessage('Daha Önce Aktarýl yapýlmýþtýr.');
          Exit;
          end;
          ...
          ShowMessage(qspbordroaktar.Params[0].AsString);
           x:=pos('Adet Personel Aktarýldý',qspbordroaktar.Params[0].AsString) ;
          if x<1 then
          begin
 ...
 EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-btnmaas_kontrolClick');
 EXIT;
 END;
...
TRY
        if FRMGIRIS.NOB_KONTROL<>'X' then
        BEGIN
          SHOWMESSAGE('Kontrol Yetkilisi Deðilsiniz !');
          exit;
        END;
                  qsor.SQL.Clear;
        ...
        if BtnNob_kontrol.Caption='Korunmuþtur' then
        begin
                  Qsql.SQL.Clear;
                  ...
                  QNOBET.Refresh;
                  showmessage('Korumasý Kaldýrýlmýþtýr');
                  BtnNob_kontrol.Caption:='Koru';
                //BtnNob_kontrol.Enabled:=false;
        end else
        begin
                  if (QNOBET.Active=false) or (QNOBET.RecordCount=0) then
                  begin
                    showmessage('Listenizde 0 kiþi var !');
                  exit;
                  end;
                  ...
                  QNOBET.Refresh;
                  showmessage('Korumaya alýnmýþtýr');
                  BtnNob_kontrol.Caption:='Korunmuþtur';
                  //BtnNob_kontrol.Enabled:=false;
                  END;
        end;
 ...
 EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-BtnNob_kontrolClick');
 EXIT;
 END;
end;
...
EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-FormActivate');
 EXIT;
 END;
...
TRY
      ...
      Action:=cafree;
EXCEPT
 sHOWMESSAGE('HATA OLUÞTU-FormClose');
 EXIT;
 END;
end;
...
//EXCEPT
// sHOWMESSAGE('HATA OLUÞTU-FormCreate');
// EXIT;
// END;
...
try
        if cxLookupComboBox2.ItemIndex=-1 then
        begin
          showmessage('Ýzinli Güne Hangi aralýðýn Girileceðini seçiniz !');
          exit;
        end;
...
//       cxLookupComboBox2.Clear;
        cxLookupComboBox2.KeyValue:=-1
EXCEPT
sHOWMESSAGE('HATA OLUÞTU-zinleriBoalt1Click');
EXIT
end;
